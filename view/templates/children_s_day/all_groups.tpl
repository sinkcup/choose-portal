...
.module_group_open_categories_nav ul li a.visiting
{
    font-weight:bold;
}
...
<?php
foreach($v['groups'] as $group_english_name=>$one_group)
{
    echo '<div class="module_group_open_categories_nav">';
    foreach($one_group as $group_name => $tmp)
    {
